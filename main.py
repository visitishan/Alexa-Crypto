...
def on_launch(event):
    onlunch_MSG = "Hi, Welcome to the Crypto Currency Price Alexa Skill. You can check the current price of Bitcoin in Indian Rupee  with it. You could say for example: price of bitcoin"
    reprompt_MSG = "Do you want to know the current price of Bitcoin?"
    card_TEXT = "Ask me about Bitcoin price."
    card_TITLE = "Ask me about Bitcoin price."
...
def player_bio(event):
    reprompt_MSG = "Do you want to know the price of Bitcoin?"
    card_TEXT = "Price of Bitcoin is rupees " + Price
    card_TITLE = "Price of Bitcoin is rupees " + Price
...
def assistance(event):
    assistance_MSG = "You can ask me for the price of Bitcoin."
    reprompt_MSG = "Do you want to know the price of Bitcoin?"
